describe('doublyLinkedList', function() {
  ...
  it('should have additional methods named "removeTail", "addToHead"', function() {
  ...
  it('should designate a new head when adding to the head of the list', function() {
  ...
  it('if two nodes are added the tail should point to the head', function() {
    doublyLinkedList.addToTail(4);
    doublyLinkedList.addToTail(5);
    expect(doublyLinkedList.contains(4)).to.equal(true);
    expect(doublyLinkedList.contains(5)).to.equal(true);
